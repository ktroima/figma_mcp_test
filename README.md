...
このリポジトリは、FigmaのDev seat / Dev ModeとMCP連携を使って、Figma上のデザイン情報とコード情報を結びつけたときに、フロントエンド実装の工数削減やデザインシステム遵守にどれだけ効果があるかを調査するための検証用リポジトリです。

詳しい背景、仮説、調査観点、成功条件は [`doc/research-purpose.md`](doc/research-purpose.md) を参照してください。
